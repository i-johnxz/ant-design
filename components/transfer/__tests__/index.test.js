...
describe('Transfer', () => {
  ...
  it('should display the correct count of items when filter by input', () => {
    ...
    const wrapper = mount(<Transfer {...searchTransferProps} showSearch filterOption={filterOption} render={renderFunc} />);
  ...
  it('should just check the filtered item when click on check all after search by input', () => {
    ...
    const renderFunc = item => item.title;
    const handleSelectChange = jest.fn();
    const wrapper = mount(<Transfer {...searchTransferProps} showSearch filterOption={filterOption} render={renderFunc} onSelectChange={handleSelectChange} />);
